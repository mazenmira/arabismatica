...
export default function DelhiRulersPage({ locale }: { locale: string }) {
    ...
    <div className="max-w-5xl mx-auto px-4 py-8" dir={isAr ? 'rtl' : 'ltr'}>
      <div className="mb-8">
        ...
        <h1 className="font-amiri text-3xl text-gold-300 mb-2">
          {isAr ? 'سلاطين دلهي' : 'Sultans of Delhi'}
        </h1>
        <p className="text-[13px] text-ink/50">
          {isAr ? '1206–1526م · انقر على اسم الحاكم لعرض عملاته' : '1206–1526 CE · Click a ruler to browse their coins'}
        </p>
      </div>
                ...
                {paged.map((ruler, i) => (
                  <tr key={ruler.en}
                    ...
                    <td className="px-3 py-2.5 text-center">
                      <Link
                        href={`/${locale}/delhi?ruler=${encodeURIComponent(ruler.en)}`}
